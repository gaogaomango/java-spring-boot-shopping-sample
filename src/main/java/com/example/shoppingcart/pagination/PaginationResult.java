...
public class PaginationResult<E> {
	...
	public PaginationResult(Query<E> query, int page, int maxResult, int maxnavigationPage) {
		...
		this.maxNavigatoinPage = maxnavigationPage;
	...
	private void calcNavigationPages() {
		...
		int begin = current - this.maxNavigatoinPage / 2;
		int end = current + this.maxNavigatoinPage / 2;
